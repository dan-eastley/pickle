...
| Item | Status | Impact |
|---|---|---|
| [DEC-1](#dec-1-end-to-end-adr-pipeline) — End-to-end ADR pipeline | 🟡 Partial | High |
| [DEC-2](#dec-2-new-decision-modal-persistence) — "New Decision" modal persistence | ✅ Done | Medium |
| [DEC-3](#dec-3-decision-narrative-migration) — Decision narrative migration | ✅ Done | Low |
| [DEC-4](#dec-4-branch-preview-for-staged-decisions) — Branch preview for STAGED decisions | ⬜ Not started | Medium |
| [DEC-5](#dec-5-inline-editing-of-decisions-replaces-the-edit-form) — Inline editing of decisions (replaces the edit form) | ✅ Done | Medium |
| [DEC-6](#dec-6-multi-party-governance--approvals) — Multi-party governance & approvals | ⬜ Not started | High |
| [DEC-7](#dec-7-hide-the-action-bar-while-editing) — Hide the action bar while editing | ⬜ Not started | Low |
| [DEC-8](#dec-8-gate-stage-advance-on-the-workflow-having-run) — Gate stage advance on the workflow having run | ✅ Done | High |
| [DEC-9](#dec-9-lock-acceptreject-once-staged) — Lock accept/reject once STAGED | ⬜ Not started | Medium |

### Discovery (Virtual Architect Agent)

| Item | Status | Impact |
|---|---|---|
| [DSC-1](#dsc-1-discovery-virtual-architect-agent) — Discovery (Virtual Architect Agent) | ✅ Done | Medium |
| [DSC-2](#dsc-2-inline-editing-of-discoveries-replace-the-edit-form) — Inline editing of discoveries (replace the edit form) | ✅ Done | Medium |

### UI & Design System

| Item | Status | Impact |
|---|---|---|
| [UI-1](#ui-1-action-bar-system) — Action-bar system | ✅ Done | Medium |
| [UI-2](#ui-2-analysis-tables) — Analysis tables | ✅ Done | Medium |
| [UI-3](#ui-3-auto-grow-fields-terminology-help-panels) — Auto-grow fields, terminology, help panels | ✅ Done | Low |
| [UI-4](#ui-4-global-search--command-palette) — Global search / command palette | ✅ Done | High |
| [UI-5](#ui-5-responsiveness-loading-skeletons-entity-deep-linking) — Responsiveness, loading skeletons, entity deep-linking | ✅ Done | Low |
| [UI-6](#ui-6-artefact-export--download) — Artefact export / download | ✅ Done | Medium |
| [UI-7](#ui-7-brandclient-specific-diagram-theming) — Brand/client-specific diagram theming | ⬜ Not started | Low |
| [UI-8](#ui-8-folder-organisation-for-decisions--discoveries) — Folder organisation for decisions & discoveries | ⬜ Not started | Medium |
| [UI-9](#ui-9-navigate-the-architecture-matrix-driven-relationship-explorer) — Navigate the architecture (matrix-driven relationship explorer) | ✅ Done | High |
| [UI-10](#ui-10-header-search-on-the-right-combined-architecturetransition-selector-on-the-left) — Header: search on the right, combined architecture/transition selector on the left | ✅ Done | Medium |
| [UI-11](#ui-11-share-link-on-every-artefact-copy-to-clipboard) — Share link on every artefact (copy to clipboard) | ✅ Done | Low |
| [UI-12](#ui-12-rename-ai-generated--pickle-generated) — Rename "AI-generated" → "PICKLE-generated" | ✅ Done | Low |
| [UI-13](#ui-13-draggable-modal-windows) — Draggable modal windows | ✅ Done | Low |
| [UI-14](#ui-14-slide-out-new-decision-call-to-action) — Slide-out: "New Decision" call-to-action | ⬜ Not started | Low |
| [UI-15](#ui-15-standardised-enum-meta-on-models-legend--inline) — Standardised enum meta on models (legend + inline) | 🟡 Partial | Medium |
...
### Editing, Modals & Settings

| Item | Status | Impact |
|---|---|---|
| [EDIT-1](#edit-1-edit-architecture--transition-via-a-reusable-settings-modal) — Edit Architecture / Transition via a reusable settings modal | ✅ Done | Medium |
| [EDIT-2](#edit-2-new-architecture--new-transition) — New Architecture / New Transition | ✅ Done | Medium |

### Architecture Model & Content

| Item | Status | Impact |
|---|---|---|
| [AMC-1](#amc-1-artefact-registry-in-config-i18n) — Artefact registry in config (i18n) | 🟡 Partial | Low |
| [AMC-2](#amc-2-derived-artefact-cascade-on-apply) — Derived-artefact cascade on apply | ✅ Done | High |
| [AMC-3](#amc-3-technology-domain--roadmaptransition-artefacts) — Technology domain + Roadmap/Transition artefacts | ⬜ Not started | Medium |
| [AMC-4](#amc-4-matrixdiagram-formats-beyond-current-set) — Matrix/diagram formats beyond current set | ⬜ Not started | Low |
| [AMC-5](#amc-5-matrix-coverage-review--find-the-missing-mappings) — Matrix coverage review — find the missing mappings | 🟡 Partial | Medium |
| [AMC-6](#amc-6-multi-sector-sample-content) — Multi-sector sample content | ✅ Done | Medium |

### Document Artefacts (Low-Level Designs)

| Item | Status | Impact |
|---|---|---|

### Roles, Access & Storage

| Item | Status | Impact |
|---|---|---|
| [RAS-1](#ras-1-roles--audienceauthor) — Roles & audience/author | ✅ Done | Medium |
| [RAS-2](#ras-2-authentication) — Authentication | ✅ Done | High |
| [RAS-3](#ras-3-authorization-rbac--per-architecture-access) — Authorization (RBAC + per-architecture access) | 🟡 Partial | High |
| [RAS-4](#ras-4-storage-for-non-github-state) — Storage for non-GitHub state | 🟡 Partial | Medium |

### Framework Alignment

| Item | Status | Impact |
|---|---|---|
| [FW-1](#fw-1-togaf-alignment) — TOGAF alignment | 🟡 Partial | Low |
| [FW-2](#fw-2-safe-alignment) — SAFe alignment | 🟡 Partial | Low |
| [FW-3](#fw-3-zachman-alignment) — Zachman alignment | 🟡 Partial | Low |
| [FW-4](#fw-4-uaf-unified-architecture-framework-alignment) — UAF (Unified Architecture Framework) alignment | 🟡 Partial | Low |

### Quality, Validation & CI

| Item | Status | Impact |
|---|---|---|
| [QV-1](#qv-1-l1--schema-validation) — L1 — Schema validation | ✅ Done | High |
| [QV-2](#qv-2-l2--referential-integrity) — L2 — Referential integrity | ✅ Done | Medium |
| [QV-3](#qv-3-path-scoped-ci) — Path-scoped CI | ✅ Done | Medium |
| [QV-4](#qv-4-lint-to-zero) — Lint to zero | ✅ Done | Low |
| [QV-5](#qv-5-accessibility-pass) — Accessibility pass | ✅ Done | Medium |
| [QV-6](#qv-6-formatting--coverage) — Formatting + coverage | ✅ Done | Low |
| [QV-7](#qv-7-footer-config-banner) — Footer config banner | ✅ Done | Low |
| [QV-8](#qv-8-productionisation-security-review) — Productionisation security review | ✅ Done | High |
| [QV-9](#qv-9-codebase-refactor--enhancement-pass) — Codebase refactor & enhancement pass | ✅ Done | Medium |

### Testing & Tooling

| Item | Status | Impact |
|---|---|---|
| [TT-1](#tt-1-use-case-corpus) — Use-case corpus | ✅ Done | Medium |
| [TT-2](#tt-2-url-mapped-screenshots--route-smoke) — URL-mapped screenshots + route smoke | ✅ Done | Low |
| [TT-3](#tt-3-decision-schema--workflow-docs) — Decision schema & workflow docs | ✅ Done | Low |

### Platform & Data Layer

| Item | Status | Impact |
|---|---|---|
| [PDL-1](#pdl-1-multi-repository-support) — Multi-repository support | ⬜ Not started | Low |
| [PDL-2](#pdl-2-bring-your-own-anthropic-credentials-per-client) — Bring-your-own Anthropic credentials (per-client) | ⬜ Not started | Medium |
| [PDL-3](#pdl-3-features-workflow-fable-review--sonnet-apply) — Features workflow: Fable review → Sonnet apply | ⬜ Not started | Low |
| [PDL-4](#pdl-4-workflow-completion-notifications-live-ui-updates) — Workflow-completion notifications (live UI updates) | 🟡 Partial | Medium |
| [PDL-5](#pdl-5-bring-your-own-github-credentials--login) — Bring-your-own GitHub credentials / login | ⬜ Not started | Medium |
...
### DEC-2: "New Decision" modal persistence
...
### DEC-4: Branch preview for STAGED decisions
...
### DEC-5: Inline editing of decisions (replaces the edit form)
...
### DEC-6: Multi-party governance & approvals
...
### DEC-7: Hide the action bar while editing
...
### DEC-8: Gate stage advance on the workflow having run
...
### DEC-9: Lock accept/reject once STAGED
...
### DSC-1: Discovery (Virtual Architect Agent)
...
### DSC-2: Inline editing of discoveries (replace the edit form)
...
### UI-3: Auto-grow fields, terminology, help panels
...
### UI-4: Global search / command palette
...
### UI-5: Responsiveness, loading skeletons, entity deep-linking
...
### UI-7: Brand/client-specific diagram theming

**Status:** ⬜ Not started · **Impact:** Low

**Proposed fix:** Allow per-client colourways for diagrams.

### UI-8: Folder organisation for decisions & discoveries
...
### UI-9: Navigate the architecture (matrix-driven relationship explorer)
...
### UI-10: Header: search on the right, combined architecture/transition selector on the left
...
### UI-11: Share link on every artefact (copy to clipboard)
...
### UI-14: Slide-out: "New Decision" call-to-action
...
### UI-15: Standardised enum meta on models (legend + inline)
...
### UI-16: Capability/Process L2: ID above the name
...
### UI-17: Analysis/change output too verbose
...
### UI-18: "To Top" link in left-hand nav
...
### EDIT-1: Edit Architecture / Transition via a reusable settings modal
...
### EDIT-2: New Architecture / New Transition
...
### AMC-1: Artefact registry in config (i18n)

**Status:** 🟡 Partial · **Impact:** Low
...
### AMC-2: Derived-artefact cascade on apply
...
### AMC-3: Technology domain + Roadmap/Transition artefacts
...
### AMC-6: Multi-sector sample content
...
### RAS-4: Storage for non-GitHub state
...
### FW-4: UAF (Unified Architecture Framework) alignment
...
### QV-8: Productionisation security review
...
### QV-9: Codebase refactor & enhancement pass
...
### TT-2: URL-mapped screenshots + route smoke
...
### TT-3: Decision schema & workflow docs
...
### PDL-1: Multi-repository support

**Status:** ⬜ Not started · **Impact:** Low

**Proposed fix:** Allow the architecture state to span more than one repository.

### PDL-2: Bring-your-own Anthropic credentials (per-client)
...
### PDL-3: Features workflow: Fable review → Sonnet apply

**Status:** ⬜ Not started · **Impact:** Low

**Proposed fix:** A code-change workflow mirroring the decisions pipeline for non-ADR changes.

### PDL-4: Workflow-completion notifications (live UI updates)
...
**Done (0.5.3-alpha):** lightweight polling on the two workflow surfaces — decisions ([DEC-8]) and now **discovery** (regenerating findings auto-refresh when a new activity entry lands; no more manual page refresh). **Vercel finding:** serverless/Edge functions can't hold a long-lived WebSocket, so a true push needs a **managed realtime service** (Pusher / Ably / Supabase Realtime — added paid dependency) or **SSE via Edge streaming** (fiddly; ties a function instance to each open connection for minutes). Given that, polling is the pragmatic choice for now.

**Proposed fix (full push, later):** A notification path so the UI knows when GitHub state has changed: at workflow completion, a final step **calls back to the API** (`repository_dispatch` / a small notify endpoint), which **pushes to the front end** over a **WebSocket** (or SSE) keyed by client/version/record id. The relevant section then flips its banner to **"This is complete — hit refresh to view"** (or auto-refetches). Needs a stateful back end ([RAS-4]) to hold connections. This is the live-update backbone for [DEC-5]/[DSC-2] (inline edits that re-dispatch) and the existing decision/discovery refresh banners. Fallback: lightweight polling of the index `updatedAt` if a socket isn't available.

### PDL-5: Bring-your-own GitHub credentials / login
...
### OPS-1: Vercel `ignoreCommand` skips multi-commit pushes ending in a data-only commit
