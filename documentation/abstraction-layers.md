...
Every domain is modelled at three layers of abstraction. Every artefact lives at exactly one layer.
...
The layers are progressive: Logical artefacts realise Conceptual ones; Physical artefacts realise Logical ones. Cross-layer relationships are captured in **Matrix** artefacts (see [output-formats.md](output-formats.md)).
