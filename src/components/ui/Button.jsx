...
const BASE =
  'inline-flex items-center justify-center gap-2 text-sm font-medium transition-colors disabled:opacity-40 disabled:cursor-not-allowed'

const VARIANTS = {
  primary: 'bg-brand-600 hover:bg-brand-700 text-white',
  secondary: 'bg-white border border-gray-300 hover:bg-gray-50 text-gray-600',
  tertiary: 'text-brand-600 hover:text-brand-700 underline underline-offset-2 !px-0',
