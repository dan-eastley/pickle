...
function AiBadge() {
  return (
    <span className="inline-flex items-center gap-1.5 align-middle" title="Generated by Pickle">
      <AiRobotIcon className="w-5 h-5" />
      <span className="text-[11px] font-bold uppercase tracking-wide bg-gradient-to-r from-brand-700 to-rose-600 bg-clip-text text-transparent">
        Pickle-generated
      </span>
    </span>
  )
...
// Brand gradient across the five steps (the canonical brand-700 → rose-600 used
// by the logo and hero), interpolated from #004EEB to #E11D48.
const STEP_COLORS = ['#004EEB', '#3842C2', '#71369A', '#A92971', '#E11D48']
